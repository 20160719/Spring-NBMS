...
<script type="text/javascript" src="<%=resoucesUrl%>/system/user/user_manage.js"></script>
...
<body>
	...
	<div class="easyui-panel" style="padding: 5px 0;">
		...
		<table id="menuTree" class="easyui-treegrid" style="width: 1000px; height: 300px" title="菜单管理" toolbar="#tb" >
