...
<script type="text/javascript" src="<%=resoucesUrl%>/system/org/org_manage.js"></script>
...
<body>
	...
	<div class="easyui-panel" style="padding: 5px 0;">
		...
		<table id="orgTree" class="easyui-treegrid" style="width: 1000px; height: 300px" title="角色管理" toolbar="#tb" >
