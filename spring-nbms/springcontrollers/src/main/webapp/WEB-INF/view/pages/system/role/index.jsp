...
<script type="text/javascript" src="<%=resoucesUrl%>/system/role/role_manage.js"></script>
...
<body>
	...
	<div class="easyui-panel" style="padding: 5px 0;">
		...
		<table id="roleTree" class="easyui-treegrid" style="width: 1600px; height: 600px" title="角色管理" toolbar="#tb" >
